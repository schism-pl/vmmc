...
fn calc_angle(or: Orientation, other: Orientation) -> f64 {
    ...
    // println!("{} {} => {cross} {}", or, other, theta.to_degrees());
    // assert!(is_radian(theta));
    theta
}
...
impl PatchyDiscsPotential {
    ...
    pub fn compute_pair_energy<P1: IsParticle, P2: IsParticle>(
        ...
        // println!("Computing pair energy between {p0} and {p1}");
        ...
        // println!("difference vector = {diff}");
        // println!("they are {dist} units apart");
